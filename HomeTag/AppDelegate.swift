...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        UITabBar.appearance().tintColor = UIColor.whiteColor() //(red: 49/255, green: 196/255, blue: 255/255, alpha: 1.0)//UIColor(red: 0.086, green: 0.494, blue: 0.655, alpha: 1.0)
        //UITabBar.appearance().barTintColor = UIColor.whiteColor()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("HomeTag", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("HomeTag.sqlite")
